    ...
    switch(page) {
        case 'projects':
            content.innerHTML = `
                <section id="projects">
                    <h2>Fun Projects</h2>
                    <button>Image Caption RNN Generator:</button>
                    <button>Neural Network Dependency Parser</button>
                    <button>Financials Visualizer</button>
                    <button>Lexical Substitution</button>
